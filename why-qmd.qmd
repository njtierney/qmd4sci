...
|        images |                           `![alternative text](https://quarto.org/)` | ![alternative text](https://quarto.org/)                         |
| footnote(s)     | `[^1]` followed by `[^1]: footnote text goes here`.| [^1] followed by [^1]: footnote text goes here. |
