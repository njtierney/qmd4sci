...
One of the big things that is different between Rmarkdown and Quarto are the chunk options. In Rmarkdown they are in the chunk header, and in quarto they are "inside" the code fence. We talk about this later on in the @sec-using-quarto.
