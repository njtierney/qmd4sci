...
* Create an Quarto document, do some basic exploration

## The anatomy of an rmarkdown document

This is an Quarto document (demo). It has three parts:
...
`format: html ` tells us we want this to be a HTML document - you'll see what this looks like in a moment!
