...
Good question. `.bib` is a format for storing references from the heyday of LaTeX. It contains scripts with reference information for the article. Here's an example one
