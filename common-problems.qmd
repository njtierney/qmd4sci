...
If you want to practice on fixing broken Quarto documents, check out some pathologically broken examples on github at

[njtierney/qmd-errors](https://github.com/njtierney/qmd-errors).
...
1.  Go to this repo [njtierney/qmd-errors](https://github.com/njtierney/qmd-errors), and give debugging some of these common rmarkdown errors a go.
...
#| eval: false
use_course("njtierney/qmd-errors")
```
