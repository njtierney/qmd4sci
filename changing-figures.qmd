# Customising your figures {#sec-options}
...
- `fig-format`: Which format do you want to save your code in? Options are: jpeg, svg, png, retina, and pdf.
...
1. Open exercise `exercises/02-qmd-figures-chunks/02-qmd-figures-chunks.qmd` Create three figures (plots created by code, e.g., `hist`, `ggplot`), with the respective dimensions (`fig-height` and `fig-width`)
    * 2x2
    * 10x10
    * 4x7
...
If you need to keep the markdown text itself, you can do this with: `keep-md: true`:
